...
describe Sunspot::Sinatra::Configuration, "default values without a sunspot.yml" do
  before(:each) do
...
describe Sunspot::Sinatra::Configuration, "with ENV['SOLR_URL'] overriding sunspot.yml" do
  before(:all) do
...
describe Sunspot::Sinatra::Configuration, "with ENV['WEBSOLR_URL'] overriding sunspot.yml" do
  before(:all) do
