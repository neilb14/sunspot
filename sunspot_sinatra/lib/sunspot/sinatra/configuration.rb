...
module Sunspot #:nodoc:
  module Sinatra #:nodoc:
    #
    # Sunspot::Sinatra is configured via the config/sunspot.yml file, which
    ...
    #
    # Sunspot::Sinatra uses the configuration to set up the Solr connection, as
    ...
    class Configuration
      ...
      # 
      # The solr home directory. Sunspot::Sinatra expects this directory
      # to contain a config, data and pids directory. See 
      # Sunspot::Sinatra::Server.bootstrap for more information.
      #
      # ==== Returns
      #
      # String:: solr_home
      ...
      #
      # Logging in sinatra_root/log as solr_<environment>.log as a 
      # default.
      #
      # ===== Returns
      #
      ...
      #
      # Memoized hash of configuration options for the current Sinatra environment
